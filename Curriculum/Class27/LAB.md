![cf](http://i.imgur.com/7v5ASc8.png) Lab : Milestone #2
=====================================
...
3. (Developer 1) As a Developer, I would like to utilize the repository design pattern so that I can easily switch between production and development environments.
